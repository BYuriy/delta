 ...
 */
public class OperationAction extends CreateAction {
    ...
    public OperationAction(ListComponent target, WindowManager.OpenType openType, OperationType operationType, com.bernatskyi.delta.entity.Operation item, boolean alwaysApplicable) {
    ...
    public OperationAction(ListComponent target, WindowManager.OpenType openType, OperationType operationType, Storage storage, boolean alwaysApplicable) {
        super(target, openType, String.format("delta$Operation%s", operationType.toString())); //todo
